# -*- coding: utf-8 -*-
"""ProyekPredictive.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1tG0UfWG1_jL83xc4uBSNjH_KahcXULp5
...
Dan hasil yang terlihat pada correlation matrix ini yaitu year, tax dan engineSize yang memiliki skor korelasi tinggi dengan fitur target 'price'
"""
...
"""Selanjutnya dilakukan drop fitur yang memiliki korelasi rendah"""

data_train.drop(['mpg', 'mileage'], inplace=True, axis=1)
data_train.head()
...
numerical_features = ['year', 'tax', 'engineSize']
...
dec =  DecisionTreeRegressor(max_depth=10, random_state=50)
...
RF = RandomForestRegressor(n_estimators=35, max_depth=10, random_state=20, n_jobs=-1)
...
boosting = AdaBoostRegressor(n_estimators=35, learning_rate=0.05, random_state=40)                             
